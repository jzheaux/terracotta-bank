...
INSERT INTO user (id, name, email, username, password, is_admin) VALUES (3, 'Admin Admin', 'admin@terracottabank.com', 'admin', 'asdfasdfasdfasdfasdfasdfasdfasdfasdfasdf', true);
INSERT INTO user (id, name, email, username, password, is_admin) VALUES (4, 'Josh Cummings', 'josh@cummings.com', 'josh.cummings', 'j0sh', false);
