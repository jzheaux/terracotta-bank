...
CREATE TABLE check (id VARCHAR(64) PRIMARY KEY, amount NUMERIC(12,4), number INTEGER, account_id VARCHAR(64))
...
INSERT INTO account (id, amount, number, owner_id) VALUES (1, 25, 987654321, 1);
